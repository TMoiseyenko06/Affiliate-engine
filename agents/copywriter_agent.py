...
AFFILIATE_SYSTEM_PROMPT = (
    ...
    "VOICE — this is the part that actually determines whether anyone clicks:\n"
    "Write like a real person sharing a genuine tip, not like an advertisement. "
    "Before writing, think about the specific person who has this exact problem: "
    "what were they frustrated by right before they'd search for this? What "
    "specific moment or feeling makes someone go 'oh, that's exactly my "
    "situation'? Lead with that relatable specificity, not with the product. "
    "Use concrete, specific details and outcomes (grounded only in the real "
    "product data given — never invented) instead of vague superlatives — "
    "specificity reads as credible and native; generic hype reads as an ad and "
    "gets scrolled past. Write with understated, matter-of-fact confidence, the "
    "way you'd tell a friend, not with exclamation points or salesy language. "
    "Avoid ad-speak entirely: no 'amazing', 'must-have', 'game-changer', "
    "'life-changing', 'don't miss out'. The goal is copy that feels like it "
    "belongs next to organic Pinterest content, not like a banner ad — while "
